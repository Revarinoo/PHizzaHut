                ...
                <div class="card-body">
                    <form action="{{route('pizza.update',$pizza->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" style="height: 45px;" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ $pizza->image }}" required autocomplete="image" autofocus>
